...
// Цена — из lib/pricing.js, общего с routes/billing.js. Своей копии здесь
// больше нет: сумма в письме-напоминании обязана совпадать с той, что реально
// спишется, а две независимые константы это не гарантировали.
